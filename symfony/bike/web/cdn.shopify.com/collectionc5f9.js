(function($) {
  ...
  var collection = {
    ...
    filterGetContent: function(newurl) {
        ...
        if (Shopify.queryParams.constraint == "300-400" )
        {
            url1 = "/bike/web/app_dev.php/Affichage_Products_prix/1" ;
            console.log(Shopify.queryParams.constraint.toString());
        }
        else if (Shopify.queryParams.constraint == "400-500" )
        {
            url1 = "/bike/web/app_dev.php/Affichage_Products_prix/2" ;
        }
        else if (Shopify.queryParams.constraint == "500-600" )
        {
            url1 = "/bike/web/app_dev.php/Affichage_Products_prix/3" ;
        }
        else if (Shopify.queryParams.constraint == "600-up" )
        {
            url1 = "/bike/web/app_dev.php/Affichage_Products_prix/4" ;
        }
    else
        {
            url1 = "/bike/web/app_dev.php/Affichage_Products" ;
        }
