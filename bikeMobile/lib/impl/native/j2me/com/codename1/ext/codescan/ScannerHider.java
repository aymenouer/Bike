...
public class ScannerHider {
     ...
     */
    CodeScannerImpl getCodeScanner() {
        try {
            ...
            //GameCanvasImplementation.MIDPVideoComponent video = new GameCanvasImplementation.MIDPVideoComponent(player, GameCanvasImplementationExt.getStaticCanvas());
            GameCanvasImplementation.MIDPVideoComponent video = (GameCanvasImplementation.MIDPVideoComponent)CodeScannerUtil.getImplementation().createMedia(uri, true, null);
