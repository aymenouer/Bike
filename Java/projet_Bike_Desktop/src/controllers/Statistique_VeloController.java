 ...
 * @author aymen
 */
public class Statistique_VeloController implements Initializable {
...
Connection c =  MyConnexion.getInsCon().getcnx();
    ...
    public void initialize(URL url, ResourceBundle rb) {
      String req ="SELECT p.Lib_C,count(*) as nombre FROM `velo` a INNER JOIN produit p WHERE p.ID_P=a.idA GROUP by p.Lib_C";
