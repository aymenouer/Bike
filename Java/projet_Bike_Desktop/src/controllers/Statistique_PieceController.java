 ...
 * @author aymen
 */
public class Statistique_PieceController implements Initializable {
...
Connection c =  MyConnexion.getInsCon().getcnx();
    ...
    @Override
     public void initialize(URL url, ResourceBundle rb) {
        String req ="SELECT p.Lib_C,count(*) as nombre FROM `piece` a INNER JOIN produit p WHERE p.ID_P=a.ID_p GROUP by p.Lib_C";
